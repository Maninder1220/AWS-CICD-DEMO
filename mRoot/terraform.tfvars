...
# CIDR ROLE NAME
cicd_role_name = "mahity-cicd-role"

# CODE COMMIT REPO NAME
repo-one-name = "mahity-repo-one"

# CODE DEPLOY APP NAME
code_deploy_app_name = "mahity-code-deploy-app"

# CODE DEPLOY GROUP NAME
deployment_group_one = "mahity-deployment-group-one"
